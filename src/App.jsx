...
function App() { 
  ...
  useEffect(() => {
    ...
    console.log("Retrieved todos from localStorage:", todoString);
    if (todoString) {
      try {
        ...
        setTodos([]); // Reset todos if JSON parsing fails
      }
    } else {
      setTodos([]); // Initialize with an empty array if nothing is in localStorage
    }
  }, []);
